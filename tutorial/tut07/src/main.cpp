...
{
    auto vsObj = CreateShaderFromFile(GL_VERTEX_SHADER, "../tut07/resources/shader.vs");
    auto fsObj = CreateShaderFromFile(GL_FRAGMENT_SHADER, "../tut07/resources/shader.fs");
...
int main(int, char **)
{
    try
    {
        auto window = InitializeWindow(800, 600, "Tutorial 07 - Interpolation Triangle - SDL2");
        InitGrapics(window);
